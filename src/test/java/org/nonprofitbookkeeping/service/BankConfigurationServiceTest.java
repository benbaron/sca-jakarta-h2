...
public class BankConfigurationServiceTest
{
    ...
    @Test
    public void createBankAccountRejectsNonCashBankLedgerAccount(@TempDir Path tempDir)
    {
        try (Jpa jpa = new Jpa(tempDir.resolve("bank-config-invalid")))
        {
            ...
            assertEquals("Linked chart account must be BANK / DEBIT / CASH.", ex.getMessage());
        }
    }
