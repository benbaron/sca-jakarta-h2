...
Status: P00 inventory of current main, updated through P15-S8-C2 all-format bank-import contract verification. This document identifies duplicate authority risks, non-H2 stores, and migration hazards before later phases choose canonical models.
