...
CREATE TABLE account (
  ...
  name VARCHAR(200) NOT NULL,
  account_type VARCHAR(20) NOT NULL, -- category: ASSET/LIABILITY/EQUITY/INCOME/EXPENSE/BANK
  subtype VARCHAR(40) NULL, -- optional: RECEIVABLE/PAYABLE/PREPAID/DEFERRED_REVENUE/etc
