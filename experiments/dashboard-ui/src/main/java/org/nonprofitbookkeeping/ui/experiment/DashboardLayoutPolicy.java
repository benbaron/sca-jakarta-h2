...
/**
 * Applies deterministic responsive dashboard breakpoints without relying on CSS media queries.
 */
public final class DashboardLayoutPolicy
{
    ...
    public static void apply(GridPane grid, double width)
    {
        ...
        Node budget = grid.getChildren().get(2);
